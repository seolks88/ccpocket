...
// Process status
 ...
 ExecutionMode get executionMode; CodexApprovalPolicy get codexApprovalPolicy; String get codexApprovalsReviewer; CodexPermissionsMode get codexPermissionsMode; bool get planMode;// Sandbox mode — Freezed default is .on but Cubit constructor overrides
// based on provider (Claude=off, Codex=on).
 ...
 double get totalCost; Duration? get totalDuration; int get totalInputTokens; int get totalCachedInputTokens; int get totalOutputTokens; int get totalToolCalls; int get totalFileEdits;// Slash commands available in this session
...
as CodexPermissionsMode,planMode: null == planMode ? _self.planMode : planMode // ignore: cast_nullable_to_non_nullable
...
as Duration?,totalInputTokens: null == totalInputTokens ? _self.totalInputTokens : totalInputTokens // ignore: cast_nullable_to_non_nullable
as int,totalCachedInputTokens: null == totalCachedInputTokens ? _self.totalCachedInputTokens : totalCachedInputTokens // ignore: cast_nullable_to_non_nullable
...
as int,totalFileEdits: null == totalFileEdits ? _self.totalFileEdits : totalFileEdits // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() final  int totalInputTokens;
@override@JsonKey() final  int totalCachedInputTokens;
@override@JsonKey() final  int totalOutputTokens;
@override@JsonKey() final  int totalToolCalls;
@override@JsonKey() final  int totalFileEdits;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChatSessionState&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._entries, _entries)&&(identical(other.approval, approval) || other.approval == approval)&&(identical(other.claudeSessionId, claudeSessionId) || other.claudeSessionId == claudeSessionId)&&(identical(other.projectPath, projectPath) || other.projectPath == projectPath)&&(identical(other.gitBranch, gitBranch) || other.gitBranch == gitBranch)&&(identical(other.explorerCurrentPath, explorerCurrentPath) || other.explorerCurrentPath == explorerCurrentPath)&&const DeepCollectionEquality().equals(other._recentPeekedFiles, _recentPeekedFiles)&&(identical(other.pastHistoryLoaded, pastHistoryLoaded) || other.pastHistoryLoaded == pastHistoryLoaded)&&(identical(other.bulkLoading, bulkLoading) || other.bulkLoading == bulkLoading)&&(identical(other.inPlanMode, inPlanMode) || other.inPlanMode == inPlanMode)&&(identical(other.collapseToolResults, collapseToolResults) || other.collapseToolResults == collapseToolResults)&&(identical(other.permissionMode, permissionMode) || other.permissionMode == permissionMode)&&(identical(other.executionMode, executionMode) || other.executionMode == executionMode)&&(identical(other.codexApprovalPolicy, codexApprovalPolicy) || other.codexApprovalPolicy == codexApprovalPolicy)&&(identical(other.codexApprovalsReviewer, codexApprovalsReviewer) || other.codexApprovalsReviewer == codexApprovalsReviewer)&&(identical(other.codexPermissionsMode, codexPermissionsMode) || other.codexPermissionsMode == codexPermissionsMode)&&(identical(other.planMode, planMode) || other.planMode == planMode)&&(identical(other.sandboxMode, sandboxMode) || other.sandboxMode == sandboxMode)&&const DeepCollectionEquality().equals(other._hiddenToolUseIds, _hiddenToolUseIds)&&(identical(other.rewindPreview, rewindPreview) || other.rewindPreview == rewindPreview)&&(identical(other.totalCost, totalCost) || other.totalCost == totalCost)&&(identical(other.totalDuration, totalDuration) || other.totalDuration == totalDuration)&&(identical(other.totalInputTokens, totalInputTokens) || other.totalInputTokens == totalInputTokens)&&(identical(other.totalCachedInputTokens, totalCachedInputTokens) || other.totalCachedInputTokens == totalCachedInputTokens)&&(identical(other.totalOutputTokens, totalOutputTokens) || other.totalOutputTokens == totalOutputTokens)&&(identical(other.totalToolCalls, totalToolCalls) || other.totalToolCalls == totalToolCalls)&&(identical(other.totalFileEdits, totalFileEdits) || other.totalFileEdits == totalFileEdits)&&const DeepCollectionEquality().equals(other._slashCommands, _slashCommands)&&(identical(other.queuedInput, queuedInput) || other.queuedInput == queuedInput));
}


@override
int get hashCode => Object.hashAll([runtimeType,status,const DeepCollectionEquality().hash(_entries),approval,claudeSessionId,projectPath,gitBranch,explorerCurrentPath,const DeepCollectionEquality().hash(_recentPeekedFiles),pastHistoryLoaded,bulkLoading,inPlanMode,collapseToolResults,permissionMode,executionMode,codexApprovalPolicy,codexApprovalsReviewer,codexPermissionsMode,planMode,sandboxMode,const DeepCollectionEquality().hash(_hiddenToolUseIds),rewindPreview,totalCost,totalDuration,totalInputTokens,totalCachedInputTokens,totalOutputTokens,totalToolCalls,totalFileEdits,const DeepCollectionEquality().hash(_slashCommands),queuedInput]);
