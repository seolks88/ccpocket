...
void main() {
  ...
  group('Codex thread options', () {
    ...
    test('ClientMessage.healthCheck serializes request id', () {
      final msg = ClientMessage.healthCheck(requestId: 'probe-1');
    ...
    test(
      'ClientMessage history requests serialize optional history controls',
      () {
